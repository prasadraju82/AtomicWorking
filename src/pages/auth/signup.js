...
function SignUp(){
    ...
    const addUser = () => {
        if(user.password !== user.confirmPassword){
            ...
            // axios.post('http://localhost:5000/api/auth/signup', userPayLoad).then(function(response){
        ...
        <div>
            <div id="outer">
                <div id="inner">
                    ...
                    <div id="lblUserName" style={{textAlign:"left", display:"block", margin: "0 auto", position:"relative", top:"5%", left:"20%", fontFamily: "Arial, Helvetica, sans-serif", fontSize: "13px", fontWeight: "bold",paddingTop:"15px"}}>
                       <div id="dvUserName" style={{width:"300px"}}>Name:<span style={{color:"red"}}>*</span></div>
                    </div>
                    <div id="Div5" style={{display:"block", margin: "0 auto", position:"relative", top:"5%", left:"19%", fontFamily: "Arial, Helvetica, sans-serif", fontSize: "13px", fontWeight: "bold",paddingTop:"2px"}}>
                       <input id="name" type ="text" value={user.name}  class="form-control" 
                                    style={{width:"300px"}} placeholder="Enter Name" onChange={handleChange} />
                    </div>
                    <div id="Div6" style={{textAlign:"left", margin: "0 auto", position:"relative", top:"5%", left:"20%", fontFamily: "Arial, Helvetica, sans-serif", fontSize: "13px", fontWeight: "bold",paddingTop:"15px"}}>
                       <div id="Div7" style={{width:"300px"}}>Email:<span style={{color:"red"}}>*</span></div>
                    </div>
                    <div id="Div1" style={{display:"block", margin: "0 auto", position:"relative", top:"5%", left:"19%", fontFamily: "Arial, Helvetica, sans-serif", fontSize: "13px", fontWeight: "bold",paddingTop:"2px"}}>
                    ...
                    <div id="Div8" style={{textAlign:"left", margin: "0 auto", position:"relative", top:"5%", left:"20%", fontFamily: "Arial, Helvetica, sans-serif", fontSize: "13px", fontWeight: "bold",paddingTop:"15px"}}>
                       <div id="Div9" style={{width:"300px"}}>Select Gender:<span style={{color:"red"}}>*</span></div>
                    </div>
                    <div id="Div3" style={{display:"block", margin: "0 auto", position:"relative", top:"5%", left:"19%", fontFamily: "Arial, Helvetica, sans-serif", fontSize: "13px", fontWeight: "bold",paddingTop:"2px"}}>
                    ...
                    <div  id="dvSetPassword" style={{display:'block', margin: "0 auto", position: "relative", top: "5%", left:"19%", fontFamily: "Arial, Helvetica, sans-serif", fontSize: "18px", fontWeight:"bold", paddingTop:"15px"}}>
                    ...
                    <div  id="dvConfirmPassword" style={{display:'block', margin: "0 auto", position: "relative", top: "5%", left:"19%", fontFamily: "Arial, Helvetica, sans-serif", fontSize: "18px", fontWeight:"bold", paddingTop:"15px"}}>
                    ...
                    <div id="Div2" style={{textAlign:"left", margin: "0 auto", position:"relative", top:"5%", left:"20%", fontFamily: "Arial, Helvetica, sans-serif", fontSize: "13px", fontWeight: "bold",paddingTop:"15px"}}>
                       <button type="button" class="btn btn-primary" style={{fontWeight:"bold", width:"300px"}}
                        onClick={() => addUser()}>SIGN UP</button>
                    </div>
                    <div id="Div4" style={{textAlign:"left", margin: "0 auto", position:"relative", top:"5%", left:"20%", fontFamily: "Arial, Helvetica, sans-serif", fontSize: "13px", fontWeight: "bold",paddingTop:"15px"}}>
